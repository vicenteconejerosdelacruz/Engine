...
#define JEXPOSE_CALLBACK(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) if(REQUIREDTOCREATE) requiredAtts.push_back(#ATT);
...
#define JEXPOSE_TRANSFORM_CALLBACK(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) if(REQUIREDTOCREATE) requiredAtts.push_back(#ATT);
...
#define JEXPOSE_CALLBACK(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) if(REQUIREDTOCREATE) creatorDrawers.insert_or_assign(#ATT, DrawCreatorValue<TYPE,JEDVALUETYPE>());
...
#define JEXPOSE_TRANSFORM_CALLBACK(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) if(REQUIREDTOCREATE) creatorDrawers.insert_or_assign(#ATT, DrawCreatorValue<TYPE,JEDVALUETYPE>());
...
#define JEXPOSE_CALLBACK(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) if(REQUIREDTOCREATE) creatorValidator.insert_or_assign(#ATT, CreatorValidValue<TYPE,JEDVALUETYPE>());
...
#define JEXPOSE_TRANSFORM_CALLBACK(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) if(REQUIREDTOCREATE) creatorValidator.insert_or_assign(#ATT, CreatorValidValue<TYPE,JEDVALUETYPE>());
