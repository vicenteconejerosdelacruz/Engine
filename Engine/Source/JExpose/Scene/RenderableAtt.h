...
JEXPOSE_VECTOR_TRANSFORM(MeshMaterial, meshMaterials, ToMeshMaterial, FromMeshMaterial, {}, jedv_t_vector, 1, true)
...
JEXPOSE_TRANSFORM(XMFLOAT3, rotation, ToXMFLOAT3, FromXMFLOAT3, XMFLOAT3(0.0f, 0.0f, 0.0f), jedv_t_float3_angle, 1, false)
