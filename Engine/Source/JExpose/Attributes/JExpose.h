...
#if defined(JEXPOSE_ATT_V8_TEMPLATES)

#define JCLASS(CLASS,GETJOBJECTS)
#define JTYPE(TYPE,VALUE)
#define JEXPOSE(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE,Update_##ATT>::json_attribute);
#define JEXPOSE_CALLBACK(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE,Update_##ATT>::json_attribute);
#define JEXPOSE_TRANSFORM(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE,Update_##ATT>::json_attribute);
#define JEXPOSE_TRANSFORM_CALLBACK(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE,Update_##ATT>::json_attribute);
#define JEXPOSE_ENUM(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE,Update_##ATT>::json_enum_attribute);
#define JEXPOSE_VECTOR(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE,Update_##ATT>::json_vector_attribute);
#define JEXPOSE_VECTOR_TRANSFORM(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE,Update_##ATT>::json_vector_attribute);
#define JEXPOSE_SET(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE,Update_##ATT>::json_set_attribute);
#define JEXPOSE_MAP_TRANSFORM(KEYTYPE,VALUETYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE)
#define JEXPOSE_MAP_OBJECT(TYPE, ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<TYPE, Update_##ATT>::json_object_attribute);
#define JEXPOSE_VECTOR_OBJECT(TYPE, ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE)
#define JEXPOSE_FLAG(ATT, INITIAL, GETFLAGSVALUESFUNCTION,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_template<unsigned int,Update_##ATT>::json_attribute);
#define JPREVIEW(NAME,JEDVALUETYPE)
#define JTRACKUUID(CLASS,NAME,LIMIT,COND)

#endif

#if defined(JEXPOSE_ATT_V8_CONTEXT)

#define JCLASS(CLASS,GETJOBJECTS)
#define JTYPE(TYPE,VALUE)
#define JEXPOSE(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE,Update_##ATT>::json_attribute );
#define JEXPOSE_CALLBACK(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE,Update_##ATT>::json_attribute );
#define JEXPOSE_TRANSFORM(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE,Update_##ATT>::json_attribute );
#define JEXPOSE_TRANSFORM_CALLBACK(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE,Update_##ATT>::json_attribute );
#define JEXPOSE_ENUM(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE,Update_##ATT>::json_enum_attribute );
#define JEXPOSE_VECTOR(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE,Update_##ATT>::json_vector_attribute );
#define JEXPOSE_VECTOR_TRANSFORM(TYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE,Update_##ATT>::json_vector_attribute );
#define JEXPOSE_SET(TYPE,ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE,Update_##ATT>::json_set_attribute );
#define JEXPOSE_MAP_TRANSFORM(KEYTYPE,VALUETYPE,ATT,TOTYPE,FROMTYPE,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE)
#define JEXPOSE_MAP_OBJECT(TYPE, ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<TYPE, Update_##ATT>::json_object_attribute );
#define JEXPOSE_VECTOR_OBJECT(TYPE, ATT,INITIAL,JEDVALUETYPE,UPDATEMASK,REQUIREDTOCREATE)
#define JEXPOSE_FLAG(ATT, INITIAL, GETFLAGSVALUESFUNCTION,UPDATEMASK,REQUIREDTOCREATE) creators.insert_or_assign(#ATT, v8_context<unsigned int,Update_##ATT>::json_attribute );
#define JPREVIEW(NAME,JEDVALUETYPE)
#define JTRACKUUID(CLASS,NAME,LIMIT,COND)
