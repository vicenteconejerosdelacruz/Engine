...
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_so_camera_name>() { return DrawUniqueSUName("Camera", Scene::GetCamerasNames); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_so_light_name>() { return DrawUniqueSUName("Light", Scene::GetLightsNames); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_so_renderable_name>() { return DrawUniqueSUName("Renderable", Scene::GetRenderablesNames); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_so_soundeffect_name>() { return DrawUniqueSUName("SoundEffects", Scene::GetSoundFXsNames); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_so_physicscene_name>() { return DrawUniqueSUName("PhysicScenes", Scene::GetPhysicScenesNames); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_so_trigger_name>() { return DrawUniqueSUName("Triggers", Scene::GetTriggersNames); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_te_material_name>() { return DrawCreatorValue<std::string, jedv_t_string>(); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_te_model3d_name>() { return DrawCreatorValue<std::string, jedv_t_string>(); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_te_renderpass_name>() { return DrawCreatorValue<std::string, jedv_t_string>(); }
template<> JEdvCreatorDrawerFunction DrawCreatorValue<std::string, jedv_t_te_shader_name>() { return DrawCreatorValue<std::string, jedv_t_string>(); }
