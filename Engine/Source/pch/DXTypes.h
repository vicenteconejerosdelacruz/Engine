...
static inline std::unordered_map<D3D12_CONSERVATIVE_RASTERIZATION_MODE, std::string> D3D12_CONSERVATIVE_RASTERIZATION_MODEToString = {
	{ D3D12_CONSERVATIVE_RASTERIZATION_MODE_OFF , "CONSERVATIVE_RASTERIZATION_MODE_OFF" },
	{ D3D12_CONSERVATIVE_RASTERIZATION_MODE_ON, "CONSERVATIVE_RASTERIZATION_MODE_ON" },
};
...
static inline std::unordered_map<std::string, D3D12_CONSERVATIVE_RASTERIZATION_MODE> StringToD3D12_CONSERVATIVE_RASTERIZATION_MODE = {
	{ "CONSERVATIVE_RASTERIZATION_MODE_OFF", D3D12_CONSERVATIVE_RASTERIZATION_MODE_OFF },
	{ "CONSERVATIVE_RASTERIZATION_MODE_ON", D3D12_CONSERVATIVE_RASTERIZATION_MODE_ON },
};
