...
### nlohmann::json [GitHub - nlohmann/json: JSON for Modern C++ 路 GitHub](https://github.com/nlohmann/json)
...
### Assimp [Open Asset Import Library 路 GitHub](https://github.com/assimp)
...
### DirectXTK12 [GitHub - microsoft/DirectXTK12: The DirectX Tool Kit (aka DirectXTK12) is a collection of helper classes for writing DirectX 12 code in C++ 路 GitHub](https://github.com/microsoft/DirectXTK12)

DirectXTK12 is used for processing the Mouse, Gamepad and Keyboard input and also is used to load images in dds format 

### DirectXTex [GitHub - microsoft/DirectXTex: DirectXTex texture processing library 路 GitHub](https://github.com/microsoft/DirectXTex)
...
### Physx [GitHub - NVIDIA-Omniverse/PhysX: NVIDIA PhysX SDK 路 GitHub](https://github.com/NVIDIA-Omniverse/PhysX)
...
### V8 [GitHub - v8/v8: The official mirror of the V8 Git repository 路 GitHub](https://github.com/v8/v8)
...
### ImGui [GitHub - ocornut/imgui: Dear ImGui: Bloat-free Graphical User interface for C++ with minimal dependencies 路 GitHub](https://github.com/ocornut/imgui)
...
### ImGuizmo [GitHub - CedricGuillemet/ImGuizmo: Immediate mode 3D gizmo for scene editing and other controls based on Dear Imgui 路 GitHub](https://github.com/cedricguillemet/imguizmo)
