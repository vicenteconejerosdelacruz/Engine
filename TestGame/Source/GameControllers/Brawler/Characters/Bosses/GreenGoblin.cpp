...
#include <JEnd.h>
	...
	*/
	...
	GreenGoblin::GreenGoblin(nlohmann::json& json) : BrawlerCharacter(json)
	{
...
#include <JEnd.h>
		...
		ggsm = {
			...
			.onStep = {
				{ GGS_None, [&](auto* sm) { greenGoblinScale = renderable->scale(); ggsm.ChangeState(GGS_Idle); }},
				{ GGS_Idle, [&](auto* sm) { /*Idle();*/ }},
...
#include <JEnd.h>
	...
	*/
	...
	/*
	void GreenGoblin::PickHeroToFight()
	{
	...
	*/
	...
	/*
	void GreenGoblin::UnregisterFromCombat()
	{
